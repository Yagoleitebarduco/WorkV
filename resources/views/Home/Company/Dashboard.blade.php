...
@section('content')
    ...
    <div class="dashboard-container">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 mb-6">
                <div class="p-4 border-b border-gray-100">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('empresa.vagas') }}" class="text-xs" style="color: var(--primary-dark);">Ver
                            todas</a>
                    </div>
                </div>
                ...
                <div class="p-3 border-t border-gray-100">
                    <button id="novaVagaBtn" class="w-full py-2 rounded-lg text-sm font-medium transition"
            ...
            <div class="grid grid-cols-2 gap-3 mb-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-3">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <a href="{{ route('empresa.candidatos') }}" class="text-[10px]"
                            style="color: var(--primary-dark);">Ver</a>
                    </div>
                    <div class="space-y-2">
        ...
        <div
            class="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white border-t border-gray-200 px-4 py-2 flex justify-around items-center">
